...
## Version v0.3.0 - Notification System, Email Templates, Sending Emails, Virtualized Project Control Planes

This version introduces new notification system with initial support for creating Email Templates and sending Emails to Users.
This release also includes virtualized project control planes so that all projects can be served by a single apiserver deployment instead of requiring multiple deployments.
